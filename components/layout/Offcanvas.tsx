				...
				<div className="sidebar-canvas-container">
					<div className="sidebar-canvas-head">
						...
						<div className="sidebar-canvas-lang">
							...
							<a className="close-canvas" onClick={handleOffcanvas}> <img alt="AD-Coches" src="/assets/imgs/template/icons/close.png" /></a>
						</div>
					</div>
					<div className="sidebar-canvas-content">
						<div className="box-author-profile">
							<div className="card-author">
								<div className="card-image"><img src="/assets/imgs/page/homepage1/author2.png" alt="AD-Coches" /></div>
