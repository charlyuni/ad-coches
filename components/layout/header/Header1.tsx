				...
				<div className="top-bar top-bar-2 top-bar-3 bg-transparent">
					<div className="container-fluid">
						<div className="text-header-info">
							<Link className="phone-head text-white"
							target="_blank"
							href="https://wa.link/azje9c">
								...
								<span className="d-none d-lg-inline-block">+34 661 33 84 34</span>
							</Link>
							<Link className="email-head text-white" href="#">
								...
								<span className="d-none d-lg-inline-block">ventas@adcoches.es</span>
							</Link>
						</div>
						...
						<div className="header-left">
							<div className="header-logo">
								<Link className="d-flex" href="/">
									<img className="light-mode" alt="AD-Coches" src="/assets/imgs/template/logo-w.svg" />
