          ...
          <div className="row align-items-end">
            <div className="col-md-9 wow fadeInUp">
              ...
              <p className="text-lg-medium text-bold neutral-500">
                Descubra la mejor selección de vehículos.
              </p>
            </div>
                ...
                <div className="swiper-wrapper">
                  <SwiperSlide>
                    <div className="card-journey-small background-card hover-up">
                      <div className="card-image card-image-content ">
                        <Link href="/clio-9367">
                          <img
                            src="/assets/imgs/cars-listing/cars-listing-1/clio1.jpg"
                            alt="AD-Coches"
                          />
                        </Link>
                      </div>
                      <div className="card-info">
                        ...
                        <div className="card-title">
                          <Link
                            ...
                            href="/clio-9367"
                          >
                            RENAULT CLIO Business Dci 90cv
                          </Link>
                        </div>
                    ...
                    {/* <div className="card-journey-small background-card hover-up">
											...
											<div className="card-info">
												...
												<div className="card-title"><Link className="heading-6 neutral-1000" href="/clio-9367">Volvo S60 D4 R-Design</Link></div>
												<div className="card-program">
													<div className="card-location">
                      ...
                      <div className="card-info">
                        ...
                        <div className="card-program">
                          ...
                          <div className="card-facitlities">
                            ...
                            <p className="card-gear text-md-medium">Manual</p>
                            <p className="card-fuel text-md-medium">Gasolina</p>
                            <p className="card-seat text-md-medium">
                              5 asientos
                            </p>
                          </div>
                  ...
                  {/* <SwiperSlide>
										<div className="card-journey-small background-card hover-up">
											<div className="card-image">
												<Link href="/clio-9367">
													<img src="/assets/imgs/cars-listing/cars-listing-1/car-3.png" alt="AD-Coches" />
												</Link>
											</div>
											<div className="card-info">
												<div className="card-rating">
												...
												<div className="card-title"><Link className="heading-6 neutral-1000" href="/clio-9367">Mercedes-Benz C220d</Link></div>
												<div className="card-program">
													<div className="card-location">
										...
										<div className="card-journey-small background-card hover-up">
											<div className="card-image">
												<Link href="/clio-9367">
													<img src="/assets/imgs/cars-listing/cars-listing-1/car-4.png" alt="AD-Coches" />
												</Link>
											</div>
											<div className="card-info">
												<div className="card-rating">
												...
												<div className="card-title"><Link className="heading-6 neutral-1000" href="/clio-9367">Jaguar XE 2.0d R-Sport</Link></div>
												<div className="card-program">
													<div className="card-location">
														<p className="text-location text-md-medium neutral-500">Manchester,
															England</p>
									...
									<SwiperSlide>
										<div className="card-journey-small background-card hover-up">
											<div className="card-image">
												<Link href="/clio-9367">
													<img src="/assets/imgs/cars-listing/cars-listing-1/car-5.png" alt="AD-Coches" />
												</Link>
											</div>
											<div className="card-info">
												<div className="card-rating">
												...
												<div className="card-title"><Link className="heading-6 neutral-1000 text-nowrap" href="/clio-9367">Volkswagen Golf GTD 2.0 TDI</Link></div>
												<div className="card-program">
													<div className="card-location">
														<p className="text-location text-md-medium neutral-500">Manchester,
															England</p>
										...
										<div className="card-journey-small background-card hover-up">
											<div className="card-image">
												<Link href="/clio-9367">
													<img src="/assets/imgs/cars-listing/cars-listing-1/car-6.png" alt="AD-Coches" />
												</Link>
											</div>
											<div className="card-info">
												<div className="card-rating">
												...
												<div className="card-title"><Link className="heading-6 neutral-1000" href="/clio-9367">Lexus IS 300h F Sport</Link></div>
												<div className="card-program">
													<div className="card-location">
														<p className="text-location text-md-medium neutral-500">Manchester,
															England</p>
