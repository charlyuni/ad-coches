								...
								<div className="swiper-wrapper">
									<SwiperSlide className="swiper-slide pb-4 pt-2">
										<div className="card-news background-card hover-up d-md-flex mb-4">
											<div className="card-image">
												<Link href="/blog-details">
													<img className="w-100" src="/assets/imgs/blog/blog-2/img-1.png" alt="AD-Coches" />
												</Link>
											</div>
										...
										<div className="card-news background-card hover-up d-md-flex mb-4">
											<div className="card-image">
												<Link href="/blog-details">
													<img className="w-100" src="/assets/imgs/blog/blog-2/img-2.png" alt="AD-Coches" />
												</Link>
											</div>
											<div className="card-info mt-0 w-68 px-4">
												<div className="card-title mb-2">
									...
									<SwiperSlide className="swiper-slide pb-4 pt-2">
										<div className="card-news background-card hover-up d-md-flex mb-4">
											<div className="card-image">
												<Link href="/blog-details">
													<img className="w-100" src="/assets/imgs/blog/blog-2/img-3.png" alt="AD-Coches" />
												</Link>
											</div>
											<div className="card-info mt-0 w-68 px-4">
												<div className="card-title mb-2">
										...
										<div className="card-news background-card hover-up d-md-flex mb-4">
											<div className="card-image">
												<Link href="/blog-details">
													<img className="w-100" src="/assets/imgs/blog/blog-2/img-4.png" alt="AD-Coches" />
												</Link>
											</div>
											<div className="card-info mt-0 w-68 px-4">
												<div className="card-title mb-2">
