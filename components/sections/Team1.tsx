					...
					<div className="row mt-50">
						...
						<div className="col-lg-3 col-md-6 col-12">
							<div className="card-news background-card hover-up shadow-2 mb-50">
								<div className="card-image">
									<Link href="/dealer-details">
										<img src="/assets/imgs/team/team-1/portrait-5.png" alt="AD-Coches" />
									</Link>
								</div>
								<div className="card-info p-4">
									<div className="card-title">
						...
						<div className="col-lg-3 col-md-6 col-12">
							<div className="card-news background-card hover-up shadow-2 mb-50">
								<div className="card-image">
									<Link href="/dealer-details">
										<img src="/assets/imgs/team/team-1/portrait-6.png" alt="AD-Coches" />
									</Link>
								</div>
								<div className="card-info p-4">
									<div className="card-title">
						...
						<div className="col-lg-3 col-md-6 col-12">
							<div className="card-news background-card hover-up shadow-2 mb-50">
								<div className="card-image">
									<Link href="/dealer-details">
										<img src="/assets/imgs/team/team-1/portrait-7.png" alt="AD-Coches" />
									</Link>
								</div>
								<div className="card-info p-4">
									<div className="card-title">
						...
						<div className="col-lg-3 col-md-6 col-12">
							<div className="card-news background-card hover-up shadow-2 mb-50">
								<div className="card-image">
									<Link href="/dealer-details">
										<img src="/assets/imgs/team/team-1/portrait-8.png" alt="AD-Coches" />
									</Link>
								</div>
								<div className="card-info p-4">
									<div className="card-title">
