				...
				<div className="container">
					<div className="row align-items-end">
						<div className="col-md-9 col-sm-9 wow fadeInUp">
							<div className="box-author-testimonials"><img src="/assets/imgs/page/homepage1/testimonial.png" alt="AD-Coches" /><img src="/assets/imgs/page/homepage1/testimonial2.png" alt="AD-Coches" /><img src="/assets/imgs/page/homepage1/testimonial3.png" alt="AD-Coches" />Testimonials</div>
											...
											<div className="card-testimonial background-card">
												<div className="card-info">
													...
													<p className="text-md-regular neutral-500">I’ve used many car rental
														platforms before, but AD-Coches’s booking system is hands down the
												...
												<div className="card-top pt-40 border-0 mb-0">
													...
													<div className="card-rate"><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="AD-Coches" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="AD-Coches" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="AD-Coches" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="AD-Coches" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="AD-Coches" />
													</div>
												</div>
											</div>
										</SwiperSlide>
