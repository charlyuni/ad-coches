						...
						<div className="row">
							<div className="col-lg-7">
								<div className="card-grid-video wow fadeIn">
									<div className="card-image"><a className="btn btn-play popup-youtube" onClick={() => setOpen(true)}> </a><img className="mr-10" src="/assets/imgs/car-review/car-review-1/img-video-1.png" alt="AD-Coches" /></div>
