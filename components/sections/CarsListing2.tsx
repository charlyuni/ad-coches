					...
					<div className="row pt-30">
								...
								<div className="card-info p-4 pt-30">
									...
									<div className="card-program">
										...
										<div className="endtime">
											...
											<div className="card-button"><Link className="btn btn-gray" href="/megane-5830">Book
												Now</Link></div>
										</div>
									</div>
								</div>
						...
						<div className="col-lg-3 col-md-6 wow fadeIn" data-wow-delay="0.2s">
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/megane-5830">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-2.png" alt="AD-Coches" />
									</Link>
								</div>
								<div className="card-info p-4 pt-30">
									<div className="card-rating">
						...
						<div className="col-lg-3 col-md-6 wow fadeIn" data-wow-delay="0.3s">
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/megane-5830">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-3.png" alt="AD-Coches" />
									</Link>
								</div>
								<div className="card-info p-4 pt-30">
									<div className="card-rating">
						...
						<div className="col-lg-3 col-md-6 wow fadeIn" data-wow-delay="0.4s">
							<div className="card-journey-small background-card hover-up">
								<div className="card-image">
									<Link href="/megane-5830">
										<img src="/assets/imgs/cars-listing/cars-listing-2/car-4.png" alt="AD-Coches" />
									</Link>
								</div>
								<div className="card-info p-4 pt-30">
									<div className="card-rating">
