					...
					<div className="page-header pt-30 background-body">
						<div className="custom-container position-relative mx-auto">
							<div className="bg-overlay rounded-12 overflow-hidden">
								<img className="w-100 h-100 img-banner" src="/assets/imgs/page-header/banner8.png" alt="AD-Coches" />
							</div>
												...
												<div className="card-contact border-0 border-bottom rounded-0 d-flex">
													<div className="card-image me-3">
														<div className="position-relative">
															<img src="/assets/imgs/dealer/dealer-listing/icon-9.svg" alt="AD-Coches" />
														</div>
													</div>
												...
												<div className="card card-body">
													...
													<div className="row g-3 mt-1">
														<div className="col-md-6">
															<img className="rounded-1" src="/assets/imgs/dealer/dealer-details/img-1.png" alt="AD-Coches" />
														</div>
														<div className="col-md-6 d-flex align-items-center justify-content-between flex-column gap-3">
															<img className="rounded-1" src="/assets/imgs/dealer/dealer-details/img-2.png" alt="AD-Coches" />
															<img className="rounded-1" src="/assets/imgs/dealer/dealer-details/img-3.png" alt="AD-Coches" />
														</div>
													</div>
												</div>
											</div>
									...
									<div className="box-grid-tours wow fadeIn">
										<div className="row">
											<div className="col-lg-3 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														<img src="/assets/imgs/cars-listing/cars-listing-6/car-6.png" alt="AD-Coches" />
													</div>
											...
											<div className="col-lg-3 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														<img src="/assets/imgs/cars-listing/cars-listing-6/car-5.png" alt="AD-Coches" />
													</div>
													<div className="card-info p-4 pt-30">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-3 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														<img src="/assets/imgs/cars-listing/cars-listing-6/car-4.png" alt="AD-Coches" />
													</div>
													<div className="card-info p-4 pt-30">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-3 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														<img src="/assets/imgs/cars-listing/cars-listing-6/car-3.png" alt="AD-Coches" />
													</div>
													<div className="card-info p-4 pt-30">
														<div className="card-rating">
															<div className="card-left" />
