...
export default function CarsDetails2() {
  ...
  const handleShareWhatsApp = () => {
    ...
    const message = `¡Descubre este coche disponible en AD-Coches! 🚗\n\nVisítalo aquí: ${url}`;
  ...
  return (
    <>
      <Layout footerStyle={2} headerStyle={2}>
        <div>
          <section className="box-section box-breadcrumb background-body">
            <div className="container">
              <ul className="breadcrumbs">
                ...
                <li>
                  <span className="text-breadcrumb">
                    Renault Mégane 1.2 Limited 115CV{" "}
                  </span>
                </li>
              </ul>
            </div>
                ...
                <div className="box-banner-activities">
                  ...
                  >
                    <div className="banner-slide-activity">
                      <img
                        src="/assets/imgs/cars-listing/cars-listing-2/megane1.jpeg"
                        alt="AD-Coches"
                      />
                    </div>
                    <div className="banner-slide-activity">
                      <img
                        src="/assets/imgs/cars-listing/cars-listing-2/megane2.jpeg"
                        alt="AD-Coches"
                      />
                    </div>
                    <div className="banner-slide-activity">
                      <img
                        src="/assets/imgs/cars-listing/cars-listing-2/megane3.jpeg"
                        alt="AD-Coches"
                      />
                    </div>
                    <div className="banner-slide-activity">
                      <img
                        src="/assets/imgs/cars-listing/cars-listing-2/megane4.jpeg"
                        alt="AD-Coches"
                      />
                    </div>
                    <div className="banner-slide-activity">
                      <img
                        src="/assets/imgs/cars-listing/cars-listing-2/megane5.jpeg"
                        alt="AD-Coches"
                      />
                    </div>
                    <div className="banner-slide-activity">
                      <img
                        src="/assets/imgs/cars-listing/cars-listing-2/megane6.jpeg"
                        alt="AD-Coches"
                      />
                    </div>
                    <div className="banner-slide-activity">
                      <img
                        src="/assets/imgs/cars-listing/cars-listing-2/megane8.jpeg"
                        alt="AD-Coches"
                      />
                    </div>
                  </Slider>
                ...
                <div className="col-lg-8">
                  ...
                  <div className="box-collapse-expand">
                    <div className="group-collapse-expand">
                      ...
                      >
                        <div className="card card-body">
                          <h1>¡No pierdas esta oportunidad! 🚗💨 📣</h1>
                          <p className="details">
                            <br />
                            <span className="highlight">
                              RENAULT MÉGANE 1.2 Limited 85kW (115CV) - 2015
                            </span>{" "}
                            📣
                            <br />
                            📍 <span className="highlight">
                            ...
                            138.334 km
                            <br />
                            ⚙️ <span className="highlight">Potencia:</span> 85
                            kW (115 CV)
                            <br />
                            🗓️{" "}
                            <span className="highlight">
                          ...
                          <p className="details">
                            ...
                            <br />
                            - Motor gasolina de bajo consumo con excelente
                            respuesta.
                            <br />
                            - ITV válida hasta 05/2025.
                            <br />
                            - 5 puertas, 5 plazas, ideal para uso familiar o
                            diario.
                            <br />
                            - Emisiones EURO 5 – solo 117g/km de CO2.
                            <br />- Tapicería de tejido original muy cuidada.
                          </p>
                        </div>
                      </div>
                    </div>
										...
										<div className="box-sidebar-content">
											<div className="box-agent-support border-bottom pb-3 mb-3">
												<div className="card-author">
													...
													<div className="card-author-info">
														<p className="text-lg-bold neutral-1000">Emily Rose</p>
														<p className="text-sm-medium neutral-500">Almería, Spain</p>
													</div>
												</div>
											</div>
											<div className="box-info-contact">
