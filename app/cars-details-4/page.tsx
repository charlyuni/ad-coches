							...
							<div className="container-banner-activities">
								<div className="box-banner-activities">
									<Slider {...settings}  className="banner-activities-detail">
										<div className="banner-slide-activity px-3"><img src="/assets/imgs/cars-details/banner.png" alt="AD-Coches" /></div>
										<div className="banner-slide-activity px-3"><img src="/assets/imgs/cars-details/banner2.png" alt="AD-Coches" /></div>
										<div className="banner-slide-activity px-3"><img src="/assets/imgs/cars-details/banner3.png" alt="AD-Coches" /></div>
										<div className="banner-slide-activity px-3"><img src="/assets/imgs/cars-details/banner4.png" alt="AD-Coches" /></div>
										<div className="banner-slide-activity px-3"><img src="/assets/imgs/cars-details/banner5.png" alt="AD-Coches" /></div>
									</Slider>
