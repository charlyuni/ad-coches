						...
						<div className="container">
							...
							<div className="row mt-60">
								...
								<div className="col-lg-3 col-sm-6">
									<div className="card-contact">
										<div className="card-image">
											<div className="card-icon background-card border rounded-2 border-dark"><img className="invert" src="/assets/imgs/page/pages/cancel.png" alt="AD-Coches" /></div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-3 col-sm-6">
									<div className="card-contact">
										<div className="card-image">
											<div className="card-icon background-card border rounded-2 border-dark"><img className="invert" src="/assets/imgs/page/pages/tech.png" alt="AD-Coches" /></div>
										</div>
										<div className="card-info">
											<div className="card-title">
