					...
					<div className="page-header pt-30 background-body">
						<div className="custom-container position-relative mx-auto">
							<div className="bg-overlay rounded-12 overflow-hidden">
								<img className="w-100 h-100 img-banner" src="/assets/imgs/page-header/banner.png" alt="AD-Coches" />
							</div>
							...
							<div className="background-body position-absolute z-1 top-100 start-50 translate-middle px-3 py-2 rounded-12 border d-flex gap-3 @@navigation-page">
								...
								<span>
									<img src="/assets/imgs/template/icons/arrow-right.svg" alt="AD-Coches" />
								</span>
					...
					<section className="section-1 py-96 background-body">
						<div className="container">
							...
							<div className="row g-4">
								...
								<div className="col-lg-4 col-md-6">
									<div className="box-image rounded-12 position-relative overflow-hidden">
										<img className="rounded-12" src="/assets/imgs/section-1/img-2.png" alt="AD-Coches" />
									</div>
								</div>
								<div className="col-lg-4 col-12">
									<div className="d-flex flex-column gap-4 align-self-stretch h-100">
										...
										<img className="rounded-12" src="/assets/imgs/section-1/img-3.png" alt="AD-Coches" />
									</div>
								</div>
							</div>
						</div>
							...
							<div className="row mt-50">
									...
									<div className="card-news background-card hover-up shadow-2 mb-4 mb-lg-0">
										<div className="card-image">
											<Link href="/dealer-details">
												<img src="/assets/imgs/team/team-1/portrait-1.png" alt="AD-Coches" />
											</Link>
										</div>
												...
												<div className="endtime">
													<div className="card-author d-flex align-items-center gap-2">
														<Link href="#" className="rounded-circle background-100 icon-shape icon icon-sm hover-up">
															<img className="m-0" src="/assets/imgs/team/team-1/icon-1.svg" alt="AD-Coches" />
														</Link>
														<Link href="#" className="rounded-circle background-100 icon-shape icon icon-sm hover-up">
															<img className="m-0" src="/assets/imgs/team/team-1/icon-2.svg" alt="AD-Coches" />
														</Link>
														<Link href="#" className="rounded-circle background-100 icon-shape icon icon-sm hover-up">
															<img className="m-0" src="/assets/imgs/team/team-1/icon-3.svg" alt="AD-Coches" />
														</Link>
														<Link href="#" className="rounded-circle background-100 icon-shape icon icon-sm hover-up">
															<img className="m-0" src="/assets/imgs/team/team-1/icon-4.svg" alt="AD-Coches" />
														</Link>
													</div>
													<Link href="/dealer-details" className="rounded-circle background-100 icon-shape icon icon-sm hover-up border icon-shape-arrow">
														<img className="m-0" src="/assets/imgs/team/team-1/arrow-up-right.svg" alt="AD-Coches" />
													</Link>
												</div>
											</div>
										</div>
								...
								<div className="col-lg-3 col-md-6 col-12">
									<div className="card-news background-card hover-up shadow-2 mb-4 mb-lg-0">
										<div className="card-image">
											<Link href="/dealer-details">
												<img src="/assets/imgs/team/team-1/portrait-2.png" alt="AD-Coches" />
											</Link>
										</div>
										<div className="card-info p-4">
											<div className="card-title">
								...
								<div className="col-lg-3 col-md-6 col-12">
									<div className="card-news background-card hover-up shadow-2 mb-4 mb-lg-0">
										<div className="card-image">
											<Link href="/dealer-details">
												<img src="/assets/imgs/team/team-1/portrait-3.png" alt="AD-Coches" />
											</Link>
										</div>
										<div className="card-info p-4">
											<div className="card-title">
								...
								<div className="col-lg-3 col-md-6 col-12">
									<div className="card-news background-card hover-up shadow-2 mb-4 mb-lg-0">
										<div className="card-image">
											<Link href="/dealer-details">
												<img src="/assets/imgs/team/team-1/portrait-4.png" alt="AD-Coches" />
											</Link>
										</div>
										<div className="card-info p-4">
											<div className="card-title">
										...
										<div className="d-flex flex-column gap-4">
											<div className="d-flex gap-4">
												<div className="position-relative">
													<img className="bdrd8 w-100" src="/assets/imgs/cta/cta-8/img-1.png" alt="AD-Coches" />
												</div>
												<div className="mt-auto">
													<img className="bdrd8 w-100" src="/assets/imgs/cta/cta-8/img-2.png" alt="AD-Coches" />
												</div>
											</div>
											<div className="d-flex gap-4">
												<div className="position-relative">
													<img className="bdrd8 w-100" src="/assets/imgs/cta/cta-8/img-3.png" alt="AD-Coches" />
												</div>
												<div className="position-relative">
													<img className="bdrd8 w-100" src="/assets/imgs/cta/cta-8/img-4.png" alt="AD-Coches" />
												</div>
											</div>
										</div>
									</div>
								...
								<div className="row align-items-center">
									<div className="col-lg-6">
										<div className="card-image d-inline-block position-relative mb-100">
											<img className="rounded-12" src="/assets/imgs/cta/cta-9/img-1.png" alt="AD-Coches" />
											<a className="btn btn-play popup-youtube position-absolute top-50 start-50 translate-middle" onClick={() => setOpen(true)} />
											<img className="position-absolute top-100 start-100 translate-middle rounded-12 d-none d-md-block" src="/assets/imgs/cta/cta-9/img-2.png" alt="AD-Coches" />
										</div>
									</div>
									<div className="col-lg-6 ps-lg-5">
										<Link className="btn btn-signin bg-2 text-dark mb-4" href="#">Our Commitment</Link>
										<h4 className="mb-4 neutral-1000">AD-Coches offers clear pricing and 24/7 great support.</h4>
										<p className="text-lg-medium neutral-500 mb-4">We are committed to offering transparent pricing with no hidden fees, comprehensive insurance options for peace of mind, and 24/7 customer support to assist you whenever you need it. At AD-Coches, your satisfaction is our top priority.</p>
										<div className="row">
											<div className="col">
												<ul className="list-ticks-green list-ticks-green-2">
													<li className="neutral-1000 pe-0">Explore a wide range of flexible rental options to suit your needs</li>
							...
							<div className="row">
								<div className="col-auto mx-auto wow fadeInUp text-center d-flex flex-column align-items-center justify-content-center">
									<div className="box-author-testimonials background-100">
										<img src="/assets/imgs/page/homepage1/testimonial.png" alt="AD-Coches" />
										<img src="/assets/imgs/page/homepage1/testimonial2.png" alt="AD-Coches" />
										<img src="/assets/imgs/page/homepage1/testimonial3.png" alt="AD-Coches" />
										Testimonials
									</div>
											...
											<div className="swiper-wrapper">
													...
													<div className="card-testimonial background-card">
														...
														<div className="card-top pt-40 border-0 mb-0">
															<div className="card-author">
																<div className="card-image"><img src="/assets/imgs/testimonials/testimonials-1/author-1.png" alt="AD-Coches" /></div>
																<div className="card-info">
																	<p className="text-lg-bold neutral-1000">Sophia Moore</p>
																	<p className="text-md-regular neutral-1000">New York</p>
																</div>
															</div>
															<div className="card-rate"><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="AD-Coches" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="AD-Coches" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="AD-Coches" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="AD-Coches" /><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-black.svg" alt="AD-Coches" /></div>
														</div>
													</div>
												</SwiperSlide>
												<SwiperSlide className="swiper-slide">
													<div className="card-testimonial background-card">
														...
														<div className="card-top pt-40 border-0 mb-0">
															<div className="card-author">
																<div className="card-image"><img src="/assets/imgs/testimonials/testimonials-1/author-2.png" alt="AD-Coches" /></div>
																<div className="card-info">
												...
												<SwiperSlide className="swiper-slide">
													<div className="card-testimonial background-card">
														...
														<div className="card-top pt-40 border-0 mb-0">
															<div className="card-author">
																<div className="card-image"><img src="/assets/imgs/testimonials/testimonials-1/author-3.png" alt="AD-Coches" /></div>
																<div className="card-info">
										...
										<div className="swiper-wrapper">
												...
												<div className="card-news background-card hover-up">
													<div className="card-image">
														<Link href="/blog-details">
															<img src="/assets/imgs/blog/blog-1/img-1.png" alt="AD-Coches" />
														</Link>
													</div>
													<div className="card-info">
														...
														<div className="card-program">
															<div className="endtime">
																<div className="card-author">
																	<img src="/assets/imgs/blog/blog-1/avatar-1.png" alt="AD-Coches" />
											...
											<SwiperSlide className="swiper-slide pt-2">
												<div className="card-news background-card hover-up">
													<div className="card-image">
														<Link href="/blog-details">
															<img src="/assets/imgs/blog/blog-1/img-2.png" alt="AD-Coches" />
														</Link>
													</div>
													<div className="card-info">
														...
														<div className="card-program">
															<div className="endtime">
																<div className="card-author">
																	<img src="/assets/imgs/blog/blog-1/avatar-2.png" alt="AD-Coches" />
											...
											<SwiperSlide className="swiper-slide pt-2">
												<div className="card-news background-card hover-up">
													<div className="card-image">
														<Link href="/blog-details">
															<img src="/assets/imgs/blog/blog-1/img-3.png" alt="AD-Coches" />
														</Link>
													</div>
													<div className="card-info">
														...
														<div className="card-program">
															<div className="endtime">
																<div className="card-author">
																	<img src="/assets/imgs/blog/blog-1/avatar-3.png" alt="AD-Coches" />
