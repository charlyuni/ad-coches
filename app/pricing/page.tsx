					...
					<div className="page-header pt-30 background-body">
						<div className="custom-container position-relative mx-auto">
							<div className="bg-overlay rounded-12 overflow-hidden">
								<img className="w-100 h-100 img-banner" src="/assets/imgs/page-header/banner2.png" alt="AD-Coches" />
							</div>
									...
									<div className="h-100 p-4 border rounded-12">
										...
										<ul className="list-unstyled mb-0 py-4 border-top mt-4">
											<li className="d-flex align-items-center mb-3">
												<img src="/assets/imgs/pricing-1/check-primary.svg" alt="AD-Coches" />
						...
						<div className="container">
							<div className="row align-items-end">
								<div className="col-md-9 mb-30 wow fadeInUp">
									...
									<p className="text-lg-medium text-bold neutral-500">Stay ah3ead with the latest car releases and upcoming events</p>
								</div>
