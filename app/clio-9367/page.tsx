          ...
          <section className="box-section box-breadcrumb background-body">
            <div className="container">
              <ul className="breadcrumbs">
                ...
                <li>
                  <span className="text-breadcrumb">RENAULT CLIO </span>
                </li>
              </ul>
            </div>
          </section>
              ...
              <div className="container-banner-activities">
                <div className="box-banner-activities">
                  ...
                  >
                    ...
                    <div className="banner-slide-activity">
                      <img
                        src="/assets/imgs/cars-listing/cars-listing-1/clio2.jpg"
                        alt="AD-Coches"
                      />
                    </div>
                    <div className="banner-slide-activity">
                      <img
                        src="/assets/imgs/cars-listing/cars-listing-1/clio3.jpg"
                        alt="AD-Coches"
                      />
                    </div>
                    <div className="banner-slide-activity">
                      <img
                        src="/assets/imgs/cars-listing/cars-listing-1/clio4.jpg"
                        alt="AD-Coches"
                      />
                    </div>
                  </Slider>
            ...
            <div className="container">
              <div className="tour-header">
                ...
                <div className="tour-metas">
                  ...
                  <Link className="btn btn-share" href="#" onClick={handleShareWhatsApp}>
                      <svg
                        width={16}
                        height={18}
                        viewBox="0 0 16 18"
                        ...
                        <div className="card card-body">
                          ...
                          <p className="details">
                            ...
                            <span className="highlight">
                              RENAULT CLIO Business Dci 66kw (90cv) - 2018
                            </span>{" "}
                            📣
                            <br />
                            📍 <span className="highlight">
                            ...
                            129.458 km
                            <br />
                            ⚙️ <span className="highlight">Potencia:</span> 66
                            kW (90 CV)
                            <br />
                            🗓️{" "}
                            <span className="highlight">
                          ...
                          <p>
                            Este Renault Clio combina economía, potencia y
                            diseño moderno, ideal para moverte por Almería y
                            disfrutar de una conducción ágil y eficiente.
                          </p>
                          <p className="details">
                            🔍{" "}
                            <span className="highlight">
                            ...
                            <br />
                            - Motor diésel económico para largas distancias.
                            <br />
                            - Equipamiento Business con gran confort y
                            funcionalidad.
                            <br />- Vehículo ideal tanto para ciudad como para
                            carretera.
                          </p>
                        </div>
                      </div>
