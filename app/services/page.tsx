					...
					<div className="page-header pt-30 background-body">
						<div className="custom-container position-relative mx-auto">
							<div className="bg-overlay rounded-12 overflow-hidden">
								<img className="w-100 h-100 img-banner" src="/assets/imgs/page-header/banner1.png" alt="AD-Coches" />
							</div>
						...
						<div className="container">
							...
							<div className="row mt-50">
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-1.png" alt="AD-Coches" />
										</div>
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-2.png" alt="AD-Coches" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-3.png" alt="AD-Coches" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-4.png" alt="AD-Coches" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-5.png" alt="AD-Coches" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-6.png" alt="AD-Coches" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-7.png" alt="AD-Coches" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-8.png" alt="AD-Coches" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
								...
								<div className="col-lg-4 col-md-6">
									<div className="card-news background-card hover-up mb-24">
										<div className="card-image">
											<img src="/assets/imgs/services/services-list-1/img-9.png" alt="AD-Coches" />
										</div>
										<div className="card-info">
											<div className="card-title mb-3">
									...
									<div className="col-lg-6">
										<div className="box-swiper">
											<Swiper {...swiperGroup1} className="swiper-container swiper-group-1">
												<div className="swiper-wrapper">
													<SwiperSlide className="swiper-slide">
														<img className="rounded-12" src="/assets/imgs/cta/cta-10/img-1.png" alt="AD-Coches" />
													</SwiperSlide>
													<SwiperSlide className="swiper-slide">
														<img className="rounded-12" src="/assets/imgs/cta/cta-10/img-1.png" alt="AD-Coches" />
													</SwiperSlide>
