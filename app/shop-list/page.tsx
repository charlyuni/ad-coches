						...
						<div className="container">
							<div className="row align-items-end">
								<div className="col-md-9 mb-30 wow fadeInUp">
									...
									<p className="text-lg-medium text-bold neutral-500">Experience The Best Car Services In AD-Coches</p>
								</div>
							</div>
						</div>
					</section>
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product1.png" alt="AD-Coches" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														...
														<div className="card-program">
															...
															<div className="endtime pt-3 mt-3 border-top">
																...
																<Link href="#" className="card-button pe-3"><img src="/assets/imgs/shop/shop-list/stock.png" alt="AD-Coches" /></Link>
															</div>
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product2.png" alt="AD-Coches" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product3.png" alt="AD-Coches" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product4.png" alt="AD-Coches" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product5.png" alt="AD-Coches" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product6.png" alt="AD-Coches" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product7.png" alt="AD-Coches" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product8.png" alt="AD-Coches" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product9.png" alt="AD-Coches" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product10.png" alt="AD-Coches" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product11.png" alt="AD-Coches" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="col-lg-4 col-md-6">
												<div className="card-journey-small background-card hover-up">
													<div className="card-image">
														...
														<img src="/assets/imgs/shop/shop-list/product12.png" alt="AD-Coches" />
													</div>
													<div className="card-info p-3 pt-30 border-top">
														<div className="card-rating">
															<div className="card-left" />
											...
											<div className="block-filter border-1">
												...
												<div className="d-flex justify-content-between pt-20 border-top">
													...
													<Link href="#" className="btn btn-primary px-3 py-2">
														<img src="/assets/imgs/template/icons/user.svg" alt="AD-Coches" />
														Apply
													</Link>
												</div>
											</div>
													...
													<ul className="list-filter-checkbox">
														<li>
															<label className="cb-container">
																<input type="checkbox" /><span className="text-sm-medium"> <img src="/assets/imgs/template/icons/star-yellow.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="AD-Coches" /></span><span className="checkmark" />
															</label>
														</li>
														<li>
															<label className="cb-container">
																<input type="checkbox" /><span className="text-sm-medium"> <img src="/assets/imgs/template/icons/star-yellow.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="AD-Coches" /></span><span className="checkmark" />
															</label>
														</li>
														<li>
															<label className="cb-container">
																<input type="checkbox" /><span className="text-sm-medium"> <img src="/assets/imgs/template/icons/star-yellow.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="AD-Coches" /></span><span className="checkmark" />
															</label>
														</li>
														<li>
															<label className="cb-container">
																<input type="checkbox" /><span className="text-sm-medium"> <img src="/assets/imgs/template/icons/star-yellow.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-yellow.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="AD-Coches" /></span><span className="checkmark" />
															</label>
														</li>
														<li>
															<label className="cb-container">
																<input type="checkbox" /><span className="text-sm-medium"> <img src="/assets/imgs/template/icons/star-yellow.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="AD-Coches" /><img src="/assets/imgs/template/icons/star-grey.svg" alt="AD-Coches" /></span><span className="checkmark" />
															</label>
														</li>
													</ul>
												</div>
									...
									<ul className="carouselTicker__list">
										...
										<li className="carouselTicker__item">
											<div className="item-brand">
												...
												<img className="dark-mode" src="/assets/imgs/page/homepage2/bmw-w.png" alt="AD-Coches" />
											</div>
										</li>
										<li className="carouselTicker__item">
											<div className="item-brand">
												<img className="light-mode" src="/assets/imgs/page/homepage2/toyota.png" alt="AD-Coches" />
