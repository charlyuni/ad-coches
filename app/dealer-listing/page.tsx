					...
					<div className="page-header pt-30 background-body">
						<div className="custom-container position-relative mx-auto">
							<div className="bg-overlay rounded-12 overflow-hidden">
								<img className="w-100 h-100 img-banner" src="/assets/imgs/page-header/banner7.png" alt="AD-Coches" />
							</div>
							...
							<div className="row mt-60">
									...
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-1.svg" alt="AD-Coches" />
											</div>
										</div>
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-2.svg" alt="AD-Coches" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-3.svg" alt="AD-Coches" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-4.svg" alt="AD-Coches" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-5.svg" alt="AD-Coches" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-6.svg" alt="AD-Coches" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-7.svg" alt="AD-Coches" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-8.svg" alt="AD-Coches" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-10.svg" alt="AD-Coches" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-11.svg" alt="AD-Coches" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-12.svg" alt="AD-Coches" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
								...
								<div className="col-lg-4 col-sm-6">
									<div className="card-contact card-dealer d-flex">
										<div className="card-image me-3">
											<div className="position-relative">
												<img src="/assets/imgs/dealer/dealer-listing/icon-13.svg" alt="AD-Coches" />
											</div>
										</div>
										<div className="card-info">
											<div className="card-title">
