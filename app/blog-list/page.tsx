							...
							<div className="row">
								<div className="col-lg-7">
									<div className="card-blog">
										<div className="card-image"><img src="/assets/imgs/blog/blog-list/img-1.png" alt="AD-Coches" /></div>
											...
											<div className="card-info-blog">
												...
												<div className="card-meta-user">
													<div className="box-author-small">
														<img src="/assets/imgs/page/homepage1/avatar.png" alt="AD-Coches" />
								...
								<div className="col-lg-5">
									<ul className="list-posts list-posts-md">
										<li>
											<div className="card-post">
												<div className="card-image">
													<Link href="/blog-details"><img src="/assets/imgs/blog/blog-list/img-2.png" alt="AD-Coches" /></Link>
												</div>
												<div className="card-info">
										...
										<li>
											<div className="card-post">
												<div className="card-image">
													<Link href="/blog-details"><img src="/assets/imgs/blog/blog-list/img-3.png" alt="AD-Coches" /></Link>
												</div>
												<div className="card-info">
										...
										<li>
											<div className="card-post">
												<div className="card-image">
													<Link href="/blog-details"><img src="/assets/imgs/blog/blog-list/img-4.png" alt="AD-Coches" /></Link>
												</div>
												<div className="card-info">
										...
										<li>
											<div className="card-post">
												<div className="card-image">
													<Link href="/blog-details"><img src="/assets/imgs/blog/blog-list/img-5.png" alt="AD-Coches" /></Link>
												</div>
												<div className="card-info">
										...
										<div className="col-lg-8">
											...
											<div className="box-grid-hotels box-grid-news mt-60 mb-50 wow fadeIn">
												<div className="card-flight card-news background-card">
													<div className="card-image">
														<Link href="/blog-details"><img src="/assets/imgs/blog/blog-list/news.png" alt="AD-Coches" /></Link>
													</div>
													<div className="card-info">
												...
												<div className="card-flight card-news background-card">
													<div className="card-image">
														<Link href="/blog-details"><img src="/assets/imgs/blog/blog-list/news2.png" alt="AD-Coches" /></Link>
													</div>
													<div className="card-info">
												...
												<div className="card-flight card-news background-card">
													<div className="card-image">
														<Link href="/blog-details"><img src="/assets/imgs/blog/blog-list/news3.png" alt="AD-Coches" /></Link>
													</div>
													<div className="card-info">
												...
												<div className="card-flight card-news background-card">
													<div className="card-image">
														<Link href="/blog-details"><img src="/assets/imgs/blog/blog-list/news4.png" alt="AD-Coches" /></Link>
													</div>
													<div className="card-info">
