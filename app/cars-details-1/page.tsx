								...
								<div className="box-banner-activities">
									<Slider
										...
										<div className="banner-slide-activity">
											<img src="/assets/imgs/cars-details/banner.png" alt="AD-Coches" />
										</div>
										<div className="banner-slide-activity">
											<img src="/assets/imgs/cars-details/banner2.png" alt="AD-Coches" />
										</div>
										<div className="banner-slide-activity">
											<img src="/assets/imgs/cars-details/banner3.png" alt="AD-Coches" />
										</div>
										<div className="banner-slide-activity">
											<img src="/assets/imgs/cars-details/banner4.png" alt="AD-Coches" />
										</div>
										<div className="banner-slide-activity">
											<img src="/assets/imgs/cars-details/banner5.png" alt="AD-Coches" />
										</div>
									</Slider>
