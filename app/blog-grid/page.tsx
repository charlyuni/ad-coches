					...
					<div className="container">
											...
											<div className="ps-md-5 ps-2 position-relative z-1">
												...
												<div className="card-meta-user">
													<div className="box-author-small">
														<img src="/assets/imgs/blog/blog-grid/avatar.png" alt="AD-Coches" />
						...
						<div className="row">
							<div className="col-lg-4 col-md-6 col-12">
								<div className="card-news background-card hover-up mb-4">
									<div className="card-image">
										<img src="/assets/imgs/blog/blog-grid/img-3.png" alt="AD-Coches" />
									</div>
										...
										<div className="card-program">
											<div className="endtime">
												<div className="card-author">
													<img className="rounded-circle border border-primary" src="/assets/imgs/blog/blog-grid/avatar1.png" alt="AD-Coches" />
							...
							<div className="col-lg-4 col-md-6 col-12">
								<div className="card-news background-card hover-up mb-4">
									<div className="card-image">
										<img src="/assets/imgs/blog/blog-grid/img-4.png" alt="AD-Coches" />
									</div>
									<div className="card-info">
										...
										<div className="card-program">
											<div className="endtime">
												<div className="card-author">
													<img className="rounded-circle border border-primary" src="/assets/imgs/blog/blog-grid/avatar2.png" alt="AD-Coches" />
													<p className="text-sm-bold neutral-1000">Jimmy Dave</p>
												</div>
												<div className="card-button"><Link className="btn btn-gray" href="/blog-details">Keep Reading</Link></div>
											</div>
							...
							<div className="col-lg-4 col-md-6 col-12">
								<div className="card-news background-card hover-up mb-4">
									<div className="card-image">
										<img src="/assets/imgs/blog/blog-grid/img-5.png" alt="AD-Coches" />
									</div>
									<div className="card-info">
										...
										<div className="card-program">
											<div className="endtime">
												<div className="card-author">
													<img className="rounded-circle border border-primary" src="/assets/imgs/blog/blog-grid/avatar3.png" alt="AD-Coches" />
													<p className="text-sm-bold neutral-1000">Jimmy Dave</p>
												</div>
												<div className="card-button"><Link className="btn btn-gray" href="/blog-details">Keep Reading</Link></div>
											</div>
							...
							<div className="col-lg-4 col-md-6 col-12">
								<div className="card-news background-card hover-up mb-4">
									<div className="card-image">
										<img src="/assets/imgs/blog/blog-grid/img-6.png" alt="AD-Coches" />
									</div>
									<div className="card-info">
										...
										<div className="card-program">
											<div className="endtime">
												<div className="card-author">
													<img className="rounded-circle border border-primary" src="/assets/imgs/blog/blog-grid/avatar4.png" alt="AD-Coches" />
													<p className="text-sm-bold neutral-1000">Jimmy Dave</p>
												</div>
												<div className="card-button"><Link className="btn btn-gray" href="/blog-details">Keep Reading</Link></div>
											</div>
							...
							<div className="col-lg-4 col-md-6 col-12">
								<div className="card-news background-card hover-up mb-4">
									<div className="card-image">
										<img src="/assets/imgs/blog/blog-grid/img-7.png" alt="AD-Coches" />
									</div>
									<div className="card-info">
										...
										<div className="card-program">
											<div className="endtime">
												<div className="card-author">
													<img className="rounded-circle border border-primary" src="/assets/imgs/blog/blog-grid/avatar5.png" alt="AD-Coches" />
													<p className="text-sm-bold neutral-1000">Jimmy Dave</p>
												</div>
												<div className="card-button"><Link className="btn btn-gray" href="/blog-details">Keep Reading</Link></div>
											</div>
							...
							<div className="col-lg-4 col-md-6 col-12">
								<div className="card-news background-card hover-up mb-4">
									<div className="card-image">
										<img src="/assets/imgs/blog/blog-grid/img-8.png" alt="AD-Coches" />
									</div>
									<div className="card-info">
										...
										<div className="card-program">
											<div className="endtime">
												<div className="card-author">
													<img className="rounded-circle border border-primary" src="/assets/imgs/blog/blog-grid/avatar6.png" alt="AD-Coches" />
													<p className="text-sm-bold neutral-1000">Jimmy Dave</p>
												</div>
												<div className="card-button"><Link className="btn btn-gray" href="/blog-details">Keep Reading</Link></div>
											</div>
							...
							<div className="col-lg-4 col-md-6 col-12">
								<div className="card-news background-card hover-up mb-4">
									<div className="card-image">
										<img src="/assets/imgs/blog/blog-grid/img-9.png" alt="AD-Coches" />
									</div>
									<div className="card-info">
										<label className="bg-2 rounded-12 position-absolute top-0 end-0 translate-middle-y px-3 py-2 me-4 text-sm-bold">Car Review</label>
										<div className="card-meta"><span className="post-date neutral-1000">18 Sep 2024</span><span className="post-time neutral-1000">6 mins</span><span className="post-comment neutral-1000">38 comments</span></div>
										...
										<div className="card-program">
											<div className="endtime">
												<div className="card-author">
													<img className="rounded-circle border border-primary" src="/assets/imgs/blog/blog-grid/avatar7.png" alt="AD-Coches" />
													<p className="text-sm-bold neutral-1000">Jimmy Dave</p>
												</div>
												<div className="card-button"><Link className="btn btn-gray" href="/blog-details">Keep Reading</Link></div>
											</div>
							...
							<div className="col-lg-4 col-md-6 col-12">
								<div className="card-news background-card hover-up mb-4">
									<div className="card-image">
										<img src="/assets/imgs/blog/blog-grid/img-10.png" alt="AD-Coches" />
									</div>
									<div className="card-info">
										<label className="bg-2 rounded-12 position-absolute top-0 end-0 translate-middle-y px-3 py-2 me-4 text-sm-bold">Car Review</label>
										<div className="card-meta"><span className="post-date neutral-1000">18 Sep 2024</span><span className="post-time neutral-1000">6 mins</span><span className="post-comment neutral-1000">38 comments</span></div>
							...
							<div className="col-lg-4 col-md-6 col-12">
								<div className="card-news background-card hover-up mb-4">
									<div className="card-image">
										<img src="/assets/imgs/blog/blog-grid/img-11.png" alt="AD-Coches" />
									</div>
									<div className="card-info">
							...
							<div className="col-lg-4 col-md-6 col-12">
								<div className="card-news background-card hover-up mb-4">
									<div className="card-image">
										<img src="/assets/imgs/blog/blog-grid/img-12.png" alt="AD-Coches" />
									</div>
									<div className="card-info">
										<label className="bg-2 rounded-12 position-absolute top-0 end-0 translate-middle-y px-3 py-2 me-4 text-sm-bold">Industry News</label>
										<div className="card-meta"><span className="post-date neutral-1000">18 Sep 2024</span><span className="post-time neutral-1000">6 mins</span><span className="post-comment neutral-1000">38 comments</span></div>
							...
							<div className="col-lg-4 col-md-6 col-12">
								<div className="card-news background-card hover-up mb-4">
									<div className="card-image">
										<img src="/assets/imgs/blog/blog-grid/img-13.png" alt="AD-Coches" />
									</div>
									<div className="card-info">
										<label className="bg-2 rounded-12 position-absolute top-0 end-0 translate-middle-y px-3 py-2 me-4 text-sm-bold">Industry News</label>
										<div className="card-meta"><span className="post-date neutral-1000">18 Sep 2024</span><span className="post-time neutral-1000">6 mins</span><span className="post-comment neutral-1000">38 comments</span></div>
							...
							<div className="col-lg-4 col-md-6 col-12">
								<div className="card-news background-card hover-up mb-4">
									<div className="card-image">
										<img src="/assets/imgs/blog/blog-grid/img-14.png" alt="AD-Coches" />
									</div>
									<div className="card-info">
										<label className="bg-2 rounded-12 position-absolute top-0 end-0 translate-middle-y px-3 py-2 me-4 text-sm-bold">Industry News</label>
										<div className="card-meta"><span className="post-date neutral-1000">18 Sep 2024</span><span className="post-time neutral-1000">6 mins</span><span className="post-comment neutral-1000">38 comments</span></div>
										...
										<div className="card-program">
											<div className="endtime">
												<div className="card-author">
													<img className="rounded-circle border border-primary" src="/assets/imgs/blog/blog-grid/avatar8.png" alt="AD-Coches" />
													<p className="text-sm-bold neutral-1000">Jimmy Dave</p>
												</div>
												<div className="card-button"><Link className="btn btn-gray" href="/blog-details">Keep Reading</Link></div>
											</div>
