									...
									<div className="container-banner-activities">
										<div className="box-banner-activities border rounded-3 overflow-hidden">
											<Slider
												...
												<div className="banner-slide-activity"><img src="/assets/imgs/shop/shop-details/img-1.png" alt="AD-Coches" /></div>
												<div className="banner-slide-activity"><img src="/assets/imgs/shop/shop-details/img-1.png" alt="AD-Coches" /></div>
												<div className="banner-slide-activity"><img src="/assets/imgs/shop/shop-details/img-1.png" alt="AD-Coches" /></div>
												<div className="banner-slide-activity"><img src="/assets/imgs/shop/shop-details/img-1.png" alt="AD-Coches" /></div>
												<div className="banner-slide-activity"><img src="/assets/imgs/shop/shop-details/img-1.png" alt="AD-Coches" /></div>
											...
											<div className="box-button-abs">
												<a className="btn btn-white-md popup-youtube" onClick={() => setOpen(true)}> <img src="/assets/imgs/page/activities/video.svg" alt="AD-Coches" />Video Clips</a>
											</div>
										</div>
										<div className="slider-thumnail-activities">
											<Slider
												...
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-1.png" alt="AD-Coches" /></div>
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-2.png" alt="AD-Coches" /></div>
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-3.png" alt="AD-Coches" /></div>
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-4.png" alt="AD-Coches" /></div>
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-1.png" alt="AD-Coches" /></div>
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-2.png" alt="AD-Coches" /></div>
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-3.png" alt="AD-Coches" /></div>
												<div className="banner-slide border p-0 mx-2 rounded-3"><img src="/assets/imgs/shop/shop-details/thumb-4.png" alt="AD-Coches" /></div>
								...
								<div className="col-lg-6 ps-lg-4">
									<div className="tour-header">
										<div className="d-flex flex-wrap align-items-center gap-4 mb-3">
											...
											<Link href="#">
												<img src="/assets/imgs/shop/shop-list/stock.png" alt="AD-Coches" />
											</Link>
										</div>
												...
												<div className="card card-body">
													<div className="head-reviews">
														<div className="review-left">
															<div className="review-info-inner">
																...
																<div className="review-rate"><img src="/assets/imgs/page/tour-detail/star.svg" alt="AD-Coches" /><img src="/assets/imgs/page/tour-detail/star.svg" alt="AD-Coches" /><img src="/assets/imgs/page/tour-detail/star.svg" alt="AD-Coches" /><img src="/assets/imgs/page/tour-detail/star.svg" alt="AD-Coches" /><img src="/assets/imgs/page/tour-detail/star.svg" alt="AD-Coches" /></div>
															</div>
														</div>
													...
													<div className="list-reviews">
														<div className="item-review">
															<div className="head-review">
																<div className="author-review">
																	<img src="/assets/imgs/blog/blog-details/avatar-1.png" alt="AD-Coches" />
																	<div className="author-info">
																		<p className="text-lg-bold">Sarah Johnson</p>
																		<p className="text-sm-medium neutral-500">December 4, 2024 at 3:12 pm</p>
																	</div>
																</div>
																<div className="rate-review"><img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-white.svg" alt="AD-Coches" /> <img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-white.svg" alt="AD-Coches" /> <img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-white.svg" alt="AD-Coches" /> <img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-white.svg" alt="AD-Coches" /> <img className="background-brand-2 p-1" src="/assets/imgs/template/icons/star-white.svg" alt="AD-Coches" /></div>
															</div>
														...
														<div className="item-review">
															<div className="head-review">
																<div className="author-review">
																	<img src="/assets/imgs/blog/blog-details/avatar-2.png" alt="AD-Coches" />
																	<div className="author-info">
														...
														<div className="item-review">
															<div className="head-review">
																<div className="author-review">
																	<img src="/assets/imgs/blog/blog-details/avatar-3.png" alt="AD-Coches" />
																	<div className="author-info">
														...
														<div className="row">
															<div className="col-lg-4">
																<div className="box-type-review">
																	...
																	<p className="rate-type-review"><img src="/assets/imgs/page/tour-detail/star-big.svg" alt="AD-Coches" /><img src="/assets/imgs/page/tour-detail/star-big.svg" alt="AD-Coches" /><img src="/assets/imgs/page/tour-detail/star-big.svg" alt="AD-Coches" /><img src="/assets/imgs/page/tour-detail/star-big.svg" alt="AD-Coches" /><img src="/assets/imgs/page/tour-detail/star-big.svg" alt="AD-Coches" /></p>
																</div>
																<div className="box-type-review">
										...
										<div className="box-sidebar-content">
											<div className="box-agent-support border-bottom pb-3 mb-3">
												<div className="card-author">
													<div className="me-2"><img src="/assets/imgs/template/icons/car-1.png" alt="AD-Coches" /></div>
										...
										<div className="p-4 background-body border rounded-3">
											...
											<div className="d-flex align-items-center mb-3">
												<div className="me-3 border rounded-3 overflow-hidden">
													<Link href="#">
														<img src="/assets/imgs/shop/shop-details/other-item1.png" alt="AD-Coches" />
													</Link>
												</div>
											...
											<div className="d-flex align-items-center mb-3">
												<div className="me-3 border rounded-3 overflow-hidden">
													<Link href="#">
														<img src="/assets/imgs/shop/shop-details/other-item2.png" alt="AD-Coches" />
													</Link>
												</div>
												<div className="position-relative">
											...
											<div className="d-flex align-items-center mb-3">
												<div className="me-3 border rounded-3 overflow-hidden">
													<Link href="#">
														<img src="/assets/imgs/shop/shop-details/other-item3.png" alt="AD-Coches" />
													</Link>
												</div>
												<div className="position-relative">
											...
											<div className="d-flex align-items-center mb-3">
												<div className="me-3 border rounded-3 overflow-hidden">
													<Link href="#">
														<img src="/assets/imgs/shop/shop-details/other-item4.png" alt="AD-Coches" />
													</Link>
												</div>
												<div className="position-relative">
											...
											<div className="d-flex align-items-center mb-3">
												<div className="me-3 border rounded-3 overflow-hidden">
													<Link href="#">
														<img src="/assets/imgs/shop/shop-details/other-item5.png" alt="AD-Coches" />
													</Link>
												</div>
												<div className="position-relative">
